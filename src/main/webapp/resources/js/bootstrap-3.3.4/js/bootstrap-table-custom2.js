...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
       ...
       this.$toolbar = $('#custom-toolbar').html('');
        ...
        /*html = [sprintf('<div class="columns columns-%s btn-group pull-%s">',*/
        		html = [sprintf('<div class="columns columns-%s btn-group pull-%s" style="margin-top: 0px; margin-left: -1px;">',
        ...
        html.push('<button id="data_look" class="btn btn-default"><i class="glyphicon glyphicon-eye-open"></i> 查看</button>');
        html.push('</div>');
        html.push('<div class="btn-group">');
        html.push('<button id="data_save" class="btn btn-default"><i class="glyphicon glyphicon-save"></i> 增加</button>');
        html.push('</div>');
        html.push('<div class="btn-group">');
        html.push('<button id="data_edit" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i> 修改</button>');
        html.push('</div>');
        html.push('<div class="btn-group">');
        html.push('<button id="data_delete" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i> 删除</button>');
        html.push('</div>');
        html.push('<div class="btn-group">');
        html.push('<button id="data_export" class="btn btn-default"><i class="glyphicon glyphicon-export"></i> 导出</button>');
        html.push('</div>');
        html.push('<div class="btn-group">');
        html.push('<button id="data_setup" class="btn btn-default"><i class="glyphicon glyphicon-cog"></i> 设置</button>');
        html.push('</div>');
        
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
                this.options.formatRefresh()),
                sprintf('<i class="%s %s"></i> %s', this.options.iconsPrefix, this.options.icons.refresh, this.options.formatRefresh()),
                '</button>');
        }
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                sprintf('<i class="%s %s"></i> %s', this.options.iconsPrefix, this.options.icons.columns, this.options.formatColumns()),
    ...
    BootstrapTable.prototype.toggleColumn = function (index, checked, needUpdate) {
        ...
        if (this.options.showColumns) {
            var $items = $("#").find('.keep-open input').prop('disabled', false);
